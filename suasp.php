	...
	<?php 
	 ...
	 <div id="container" style="width: 600px; margin: auto; background: pink">
		<form method="POST">
				...
				<tr>
					...
					<td>
						<select name="txthangsua" id="txthangsua">
							...
							<option value="Ducth Lady"	<?php if($hangsua == "Ducth Lady") echo "selected"; ?>>Ducth Lady</option>
							<option value="Ensure"		<?php if($hangsua == "Ensure") echo "selected"; ?>>Ensure</option>
							<option value="Nutifood"	<?php if($hangsua == "Nutifood") echo "selected"; ?>>Nutifood</option>
							<option value="TH TrueMilk"	<?php if($hangsua == "TH TrueMilk") echo "selected"; ?>>TH TrueMilk</option>
						</select>
					</td>
				</tr>
				<tr>
			...
			<a href="thongtinSP.php">Danh sách sản phẩm</a>
